...
python3 lib/BIN-Patcher/bins/sotn-us/generate-extraction-template.py "lib/BIN-Patcher/bins/sotn-us/data/extraction-template.yaml" "build/patcher/extraction-template.json"
